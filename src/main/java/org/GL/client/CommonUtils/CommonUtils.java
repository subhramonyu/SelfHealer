package org.GL.client.CommonUtils;
...
import org.GL.client.CommonUtils.Constants.LocatorStrategy;
...
public class CommonUtils {
	...
	/*
	 * static { actions = new Actions(DriverManager.getDriver()); javaScriptExecutor
